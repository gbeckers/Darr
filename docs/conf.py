...
# -*- coding: utf-8 -*-
#
# darr documentation build configuration file, created by
...
project = 'darr'
copyright = '2017-2024, Gabriel Beckers'
...
latex_documents = [
    (master_doc, 'darr.tex', 'darr Documentation',
...
man_pages = [
    (master_doc, 'darr', 'darr Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'darr', 'darr Documentation',
     author, 'darr', 'One line description of project.',
     'Miscellaneous'),
]
