...
v = np.memmap('values/arrayvalues.bin', dtype='<f4', shape=(24, 2), order='C')
...
v = readBin(con=fileid, what=numeric(), n=48, size=4, signed=TRUE, endian="little")
...
v = fread(fileid, [2, 24], '*float32', 'ieee-le');
fclose(fileid);
