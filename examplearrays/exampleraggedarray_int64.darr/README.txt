...
v = np.memmap('values/arrayvalues.bin', dtype='<i8', shape=(24, 2), order='C')
...
v = readBin(con=fileid, what=integer(), n=48, size=8, signed=TRUE, endian="little")
...
v = fread(fileid, [2, 24], '*int64', 'ieee-le');
fclose(fileid);
