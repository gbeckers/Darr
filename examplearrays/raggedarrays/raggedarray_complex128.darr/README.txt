...
v = read_binary("values/arrayvalues.bin", data_type=9, data_dims=[2, 26], endian="little")
...
(* read complex128 values array: *)
v = BinaryReadList["values/arrayvalues.bin", "Complex128", ByteOrdering -> -1];
...
v = mget(104, "dl", fileid);
v = matrix(v, [2, 2, 26]);
mclose(fileid);
v = complex(squeeze(v(1,:,:)),squeeze(v(2,:,:)));
/* create an anonymous function that returns the k-th subarray */
/* from the values array: */
