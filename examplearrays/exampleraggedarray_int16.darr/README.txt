...
v = np.memmap('values/arrayvalues.bin', dtype='<i2', shape=(24, 2), order='C')
...
v = readBin(con=fileid, what=integer(), n=48, size=2, signed=TRUE, endian="little")
...
v = fread(fileid, [2, 24], '*int16', 'ieee-le');
fclose(fileid);
